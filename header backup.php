...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="css/styles.css?v=12221123" />
          ...
          <div class="container-fluid">
            <div class="row">
                <div class="navbar-header">
                  <a class="navbar-brand" href="#"><img src="img/logo-new.png" class="img-brand" height="50px" width="100%"></a>
                  <div class="dropdown">
                  	  <span class="caret" data-toggle="dropdown"></span>
                  	  <ul class="dropdown-menu sub-menu1 text-center">
					      <li><a href="#">Pull Sms</a></li>
					      <li><a href="#">Push Sms</a></li>
					      <li><a href="#">Voice</a></li>
					      <li><a href="#">Email</a></li>
					      <li><a href="#">Developers</a></li>
					      <li><a href="#">Txtly</a></li>
